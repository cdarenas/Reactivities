...
const App = () => {
  ...
  if (loading) return <LoadingComponent content='Loading Hacktivities...'></LoadingComponent>
    ...
    <Fragment>
      ...
      <Container style={{ marginTop: '7em' }}>
        <ActivityDashboard activities={activities} selectActivity={handleSelectActivity} selectedActivity={selectedActivity!}
          ...
          createActivity={handleCreateActivity} editActivity={handleEditActivity} deleteActivity={handleDeleteActivity} submitting={submitting}
